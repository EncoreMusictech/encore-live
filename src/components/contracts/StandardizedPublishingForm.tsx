  ...
  const handleSave = async () => {
    try {
      const contractPayload = {
        ...
        advance_amount: (formData as any).advance_amount ? parseFloat((formData as any).advance_amount) : (formData.advanceAmount ? parseFloat(formData.advanceAmount) : undefined),
