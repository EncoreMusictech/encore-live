            ...
            <TabsContent value="terms" className="space-y-6 mt-0">
              ...
              <div className="grid gap-6">
                ...
                {contract.contract_data && Object.keys(contract.contract_data).length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle>Contract Specific Terms</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                ...
                {contract.royalty_splits && Object.keys(contract.royalty_splits).length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle>Royalty Split Configuration</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                ...
                {contract.notes && (
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm whitespace-pre-wrap bg-gray-50 p-4 rounded-lg">{contract.notes}</p>
                    </CardContent>
                  </Card>
                )}
              </div>
