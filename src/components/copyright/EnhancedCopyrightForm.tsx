  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cleanFormData: Omit<CopyrightInsert, 'user_id'> = {
        ...
        ascap_status: formData.ascap_status || null,
        bmi_status: formData.bmi_status || null,
        socan_status: formData.socan_status || null,
        sesac_status: formData.sesac_status || null,
