...
export interface ReconciliationBatch {
  ...
  source: 'DSP' | 'PRO' | 'YouTube' | 'BMI' | 'ASCAP' | 'SESAC' | 'SOCAN' | 'Spotify' | 'Apple Music' | 'Amazon Music' | 'Tidal' | 'Pandora' | 'SiriusXM' | 'Test Source' | 'Shondaland' | 'NBC' | 'SoundExchange' | 'NFL Productions' | 'Custom Source' | 'Other';
