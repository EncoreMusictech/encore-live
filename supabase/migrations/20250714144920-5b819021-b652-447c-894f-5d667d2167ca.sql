...
('Starter Bundle', 'Perfect for independent artists and small operations', 0.00, 0.00, '["contract-management", "copyright-management"]', 0.00, false, '["Contract Management", "Copyright Management", "Up to 100 tracks", "Basic reporting", "Email support"]'::jsonb),
('Professional Bundle', 'Ideal for managers, small labels, and growing businesses', 49.00, 490.00, '["contract-management", "copyright-management", "catalog-valuation", "sync-licensing", "client-portal"]', 25.00, true, '["All Starter features", "Catalog Valuation", "Sync Licensing Tracker", "Client Portal", "Unlimited tracks", "Advanced reporting", "Priority support"]'::jsonb),
('Enterprise Bundle', 'For large publishers, labels, and rights organizations', 99.00, 990.00, '["contract-management", "copyright-management", "catalog-valuation", "sync-licensing", "client-portal", "royalties-processing"]', 35.00, false, '["All Professional features", "Royalties Processing", "Custom integrations", "Dedicated account manager", "API access", "White-label options", "SLA guarantee"]'::jsonb);