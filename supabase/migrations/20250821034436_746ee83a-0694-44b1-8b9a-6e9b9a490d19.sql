-- Fix the calculate_payout_fields function to resolve the ambiguous column reference
...
DECLARE
    ...
    client_contact_name text;  -- Changed variable name to avoid ambiguity
...
BEGIN
    ...
    AND counterparty_name = client_contact_name  -- Fixed variable name
