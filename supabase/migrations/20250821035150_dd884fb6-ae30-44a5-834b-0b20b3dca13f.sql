-- Fix the calculate_payout_fields function to include 'signed' contracts for commission calculation
...
-- Update existing payout records to trigger recalculation with the fixed function
UPDATE public.payouts 
SET updated_at = now()
WHERE commissions_amount = 0 AND total_royalties > 0;