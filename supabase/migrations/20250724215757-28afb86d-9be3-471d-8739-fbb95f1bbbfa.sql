-- Drop and recreate the log_copyright_activity function to allow 'bulk_upload' action type
DROP FUNCTION IF EXISTS public.log_copyright_activity(uuid,uuid,text,jsonb,text[],jsonb,jsonb,uuid,text,text);
